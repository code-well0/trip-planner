...
function ChatBot() {
  ...
  return (
    <div className="flex items-center justify-center p-4 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50" style={{minHeight: 'calc(100vh - 70px)', marginTop: '70px'}}>
