      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-14">
          ...
          <div className="flex flex-col">
            <label className="mb-2 text-gray-800 dark:text-gray-200 font-semibold text-sm tracking-wide">Mood</label>
            <select
              value={selectedMood}
                ...
                <div className="p-5">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs font-medium">
                    {place.moodTags.map((tag, i) => (
                      <span key={i} className="bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 px-3 py-1 rounded-full">{tag}</span>
                    ))}
                    {place.purposeTags.map((tag, i) => (
                      <span key={i} className="bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300 px-3 py-1 rounded-full">{tag}</span>
                    ))}
                    {place.themeTags && place.themeTags.map((tag, i) => (
                      <span key={i} className="bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-300 px-3 py-1 rounded-full">{tag}</span>
                    ))}
                  </div>
                </div>
              </div>
