                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 border-b border-gray-300 dark:border-gray-700 pb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/CustomItenary" onClick={(e) => handleProtectedClick(e, '/CustomItenary')} className="hover:text-blue-500 transition-colors duration-200">AI Powered Custom Itinerary</Link></li>
