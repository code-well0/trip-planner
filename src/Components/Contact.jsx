...
//             <h1 className="contact-header">📩 Contact Your Trip Planner</h1>
//             <h3>Whether you have a question, feedback, or just want to share your travel story, our team is here to help. Reach out to us through any of the channels below, and we'll get back to you as soon as possible!</h3>
//             <p>"Your satisfaction is our top priority. If you encounter any issues while using our platform or have questions about our services, our dedicated support team is ready to assist you. We pride ourselves on prompt, helpful responses to ensure your travel planning experience remains smooth and enjoyable.</p>
...
//             </div>
//             <p className="tags">🧳 "From Itineraries to Memories – We've Got You Covered."</p>
//             <h3 className="touch">Get in touch</h3>
//             <div className="social-links">
//                 <a href="#"><i className="fab fa-twitter"></i></a>
//                 <a href="https://www.linkedin.com/in/shubrali-jain"><i className="fab fa-linkedin"></i></a>
//                 <a href="https://github.com/code-well0"><i className="fab fa-github"></i></a>
//             </div>
//         </div>
//     )
// }
